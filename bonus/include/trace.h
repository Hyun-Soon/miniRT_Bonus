...
/*   Updated: 2023/12/28 12:11:12 by yusekim          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_bool		hit(t_object *obj, t_ray *ray, t_hit_rec *rec, t_param *par);
// t_bool		hit_obj(t_object *obj, t_ray *ray, t_hit_rec *rec);
t_bool		hit_obj(t_object *obj, t_ray *ray, t_hit_rec *rec, t_param *par);
// t_color3	phong_lighting(t_scene *scene);
t_color3	phong_lighting(t_scene *scene, t_param *par);
